...
def create_population(metadata, population_size, configurations):
    ...
    for individual in range(population_size):
        ...
        util.write_metadata(configurations.intermediate_test_suite_path.value, solution.test_suite, metadata, None)
...
def create_offspring(test_suite, configurations, metadata):
    ...
    util.write_metadata(configurations.intermediate_test_suite_path.value, individual.test_suite, metadata, None)
